                        ...
                        <div className="row">
                            ...
                            <div className="col-md-6">                                
                                <Form.Group className="row" controlId="validation_Commodity_Code">
                                    <Form.Label className="col-sm-5 col-form-label">Commodity Code:</Form.Label>
                                    <div className="col-sm-7">
                                        <Select  
                                            isClearable={true}  
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-6">
                                <Form.Group className="row" controlId="validation_StockNo">
                                    ...
                                    <div className="col-sm-7">
                                            <Form.Control  type="text" value={StockNo} onChange={(e) => setStockNo(e.target.value)}  disabled={StockNo_disabled}/>
                                        </div>
                                </Form.Group>
                            </div>
                            ...
                            <div className="col-md-6">                                
                                <Form.Group className="row" controlId="validation_Stock_Group">
                                    <Form.Label className="col-sm-5 col-form-label">Stock Group:</Form.Label>
                                    <div className="col-sm-7">
                                        <Select  
                                            isClearable={true}  
                                            options={Stock_Group}
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-6">                                
                                <Form.Group className="row" controlId="validation_Part_No">
                                    <Form.Label className="col-sm-5 col-form-label">Part No:</Form.Label>
                                    <div className="col-sm-7">
                                    <Form.Control  type="text" value={Part_No} onChange={(e) => setPart_No(e.target.value)}/>
                                    </div>
                                </Form.Group>
                            </div>
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-6">                                
                                <Form.Group className="row" controlId="validation_TotalOH">
                                    <label className="col-sm-5 col-form-label">Total OH:</label>
                                    <div className="col-sm-7">
                                        <Form.Control type="number" placeholder="0.0000" value={TotalOH} onChange={(e) => setTotalOH(e.target.value)} readOnly/>
                                    </div>
                                </Form.Group>
                            </div>
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-6">                                
                                <Form.Group className="row" controlId="validation_IssuePrice">
                                    <label className="col-sm-5 col-form-label">Issue Price:</label>
                                    <div className="col-sm-7">
                                        <Form.Control type="number" placeholder="0.00" value={IssuePrice} onChange={(e) => setIssuePrice(e.target.value)} readOnly/>
                                    </div>
                                </Form.Group>
                            </div>
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-6">                                
                                <Form.Group className="row" controlId="validation_SerializeCounter">
                                    <label className="col-sm-5 col-form-label">Serialize Counter:</label>
                                    <div className="col-sm-7">
                                        <Form.Control type="number" placeholder="100001" value={SerializeCounter} onChange={(e) => setSerializeCounter(e.target.value)} readOnly/>
                                    </div>
                                </Form.Group>
                            </div>
                    ...
                    <Tabs defaultActiveKey="Details" id="uncontrolled-tab-example" className="mb-4">
                                    ...
                                    <div className="row">
                                        <div className="col-md-6">
                                            <Form.Group className="row" controlId="validation_ConversionFactor">
                                                ...
                                                <div className="col-sm-7">
                                                <Form.Control type="number" placeholder='1.0000' value={ConversionFactor} onChange={(e) => setConversionFactor(e.target.value)} readOnly/>
                                            </div>
                                            </Form.Group>
                                        </div>
                                        ...
                                        <div className="col-md-6">
                                            <Form.Group className="row" controlId="validation_ABCClass">
                                                ...
                                                <div className="col-sm-4 form-check">
                                                <Form.Control  type="text" value={ABCClass} onChange={(e) => setABCClass(e.target.value)}/>
                                                </div>
                                            </Form.Group>
                                        </div> 
                                    ...
                                    <div className="row">
                                        <div className="col-md-6">
                                            <Form.Group className="row" controlId="validation_EOQ">
                                                ...
                                                <div className="col-sm-7">
                                                <Form.Control type="number" placeholder='0' value={EOQ} onChange={(e) => setEOQ(e.target.value)} readOnly/>
                                            </div>
                                            </Form.Group>
                                        </div>
                        ...
                        <div className="row">
                            <div className="col-md-6">
                                ...
                                <div className="col-sm-6">
                                <Form.Control type="number" placeholder="0.0000" value={YTDUsage} onChange={(e) => setYTDUsage(e.target.value)} readOnly/>
                                </div>
                                </Form.Group>
                            </div>
                            ...
                            <div className="col-md-6">
                                ...
                                <div className="col-sm-6">
                                <Form.Control type="number" placeholder="0.0000" value={LastYearUsage} onChange={(e) => setLastYearUsage(e.target.value)} readOnly/>
                                </div>
                                </Form.Group>
                            </div>
                        ...
                        <div className="row">
                            <div className="col-md-6">
                                ...
                                <div className="col-sm-6">
                                <Form.Control type="number" placeholder="0.0000" value={YTDTurns} onChange={(e) => setYTDTurns(e.target.value)} readOnly/>
                                </div>
                                </Form.Group>
                            </div>
                            ...
                            <div className="col-md-6">
                                ...
                                <div className="col-sm-6">
                                <Form.Control type="number" placeholder="0.0000" value={LastYearTurns} onChange={(e) => setLastYearTurns(e.target.value)} readOnly/>
                                </div>
                                </Form.Group>
                            </div>
                        ...
                        <div className="row">
                            <div className="col-md-6">
                                ...
                                <div className="col-sm-6">
                                <Form.Control type="number" placeholder="0.0000" value={YTDStockouts} onChange={(e) => setYTDStockouts(e.target.value)} readOnly/>
                                </div>
                                </Form.Group>
                            </div>
                            ...
                            <div className="col-md-6">
                                ...
                                <div className="col-sm-6">
                                <Form.Control type="number" placeholder="0.0000" value={LastYearStockouts} onChange={(e) => setLastYearStockouts(e.target.value)} readOnly/>
                                </div>
                                </Form.Group>
                            </div>
