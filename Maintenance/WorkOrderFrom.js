...
// **************************************** check read data ******************************************
    ...
    const New_WorkOrder = () => {
        ...
        //Select Status
        let Status = selected_Status.label.split(":")
        ...
        console.log('Projaaaaaaaaaa', selected_Project_ID.label)
                            ...
                            <div className="col-md-12">
                                <Form.Group className="row" controlId="validation_Description">
                                    ...
                                    <Form.Control 
                                        as="textarea" 
                                        rows={12} 
                                        value={selected_Fault_Code ? selected_Fault_Code.value : Description}
                                        onChange={(e) => {
                    ...
                    <Tabs defaultActiveKey="Details" id="uncontrolled-tab-example" className="mb-4">
                        ...
                        <Tab eventKey="Details" title="Details" class="nav-link active">
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-md-6">
                                            <Form.Group className="row" controlId="validation_AssetStatus">
                                                <label className="col-sm-3 col-form-label"><span style={{color: "red"}} class="required-asterisk">* </span>Original Periority:</label>
                                                <div className="col-sm-7">
                                                    <Select  
                                                        isClearable={true}  
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-md-6">
                                            <Form.Group className="row">
                                                <label className="col-sm-3 col-form-label">Schedule Date:</label>
                                                <div className="col-sm-7">
                                                <Form.Control                                            
                                                        type="datetime-local"  
                                                        value={ScheduleDate} 
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-md-6">
                                            <Form.Group className="row">
                                                <label className="col-sm-3 col-form-label">Exception Date:</label>
                                                <div className="col-sm-7">
                                                <Form.Control                                            
                                                        type="datetime-local"  
                                                        value={ExceptionDate} 
                                    ...
                                    <div className='row'>
                                        ...
                                        <div className="col-md-6">
                                            <Form.Group className="row">
                                                <label className="col-sm-3 col-form-label">Status Change Date:</label>
                                                <div className="col-sm-7">
                                                <Form.Control                                            
                                                        type="datetime-local"  
                                    ...
                                    <div className="row">
                                        <div className="col-md-6">
                                            <Form.Group className="row">
                                                ...
                                                <div className="col-sm-7">
                                                    <Form.Control  type="text" value={Permanent_ID} onChange={(e) => setPermanent_ID(e.target.value)}/>
                                                </div>
                                            </Form.Group>
                                        </div>
