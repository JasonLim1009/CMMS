...
// **************************************** check read data ******************************************
    ...
    const New_Employee =()=>{
        ...
        //Select Login Id
        let Employee_Login_Id = selected_Employee_Login_Id.label.split(":")
        ...
        let Employee_Supervisor_Id = selected_Employee_Supervisor_Id.label.split(":")
    ...
    var json_employee = {
        ...
        "emp_det_supervisor_id":Employee_Supervisor_Id[0].trim(),            
                    ...
                    <Tabs defaultActiveKey="Details" id="uncontrolled-tab-example" className="mb-4">
                                    ...
                                    <div className='row'>
                                        <div className="col-md-6">
                                            <Form.Group className="row">
                                                ...
                                                <div className="col-sm-9">
                                                    <Form.Control  type="text" value={Emp_EmailID} onChange={(e) => setEmp_EmailID(e.target.value)}/>
                                                </div>
                                            </Form.Group>
                                        </div>    
                        ...
                        <Tab eventKey="Settings" title="Settings" class="nav nav-tabs nav-item nav-link active">
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-3">
                                    <Form.Group className="mb-3">
                                            <Form.Control  type="number" placeholder=".00" value={selected_MrApprover} disabled ={MrApprover} onChange={(e) => setselected_MrApprover(e.target.value)} />
                                    </Form.Group>
                                </div>

                                <div className="col-md-3">
                                    <Form.Group className="row">
                                        <label className="col-sm-10 col-form-label">Schedule Work Order:</label>
                                        <div className="col-sm-2 form-check">
                                            <label className="form-check-label">
                                                <input type="checkbox" 
                                                className="form-check-input"
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-3">
                                    <Form.Group className="mb-3">
                                            <Form.Control  type="text" placeholder=".00" value={selected_WoBudgetApprover} disabled ={WoBudgetApprover} onChange={(e) => setselected_WoBudgetApprover(e.target.value)} />
                                    </Form.Group>
                                </div> 
                                
                                <div className="col-md-3">
                                    <Form.Group className="row">
                                        <label className="col-sm-10 col-form-label">PO Buyer:</label>
                                        <div className="col-sm-2 form-check">
                                            <label className="form-check-label">
                                                <input type="checkbox" 
                                                className="form-check-input"
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-3">
                                    <Form.Group className="mb-3">
                                            <Form.Control  type="text" placeholder=".00" value={selected_PrApprover} disabled ={PrApprover} onChange={(e) => setselected_PrApprover(e.target.value)} />
                                    </Form.Group>
                                </div>  

                                <div className="col-md-3">
                                    <Form.Group className="row">
                                        <label className="col-sm-10 col-form-label">Supervisor:</label>
                                        <div className="col-sm-2 form-check">
                                            <label className="form-check-label">
                                                <input type="checkbox" 
                                                className="form-check-input"
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-3">
                                    <Form.Group className="row">
                                        <label className="col-sm-10 col-form-label">Foreman:</label>
                                        <div className="col-sm-2 form-check">
                                            <label className="form-check-label">
                                                <input type="checkbox" 
                                                className="form-check-input"
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-3">
                                    <Form.Group className="row">
                                        <label className="col-sm-10 col-form-label">Asset Tagging Posting:</label>
                                        <div className="col-sm-2 form-check">
                                            <label className="form-check-label">
                                                <input type="checkbox" 
                                                className="form-check-input"
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-3">
                                    <Form.Group className="row">
                                        <label className="col-sm-10 col-form-label">Add/Delete Check List:</label>
                                        <div className="col-sm-2 form-check">
                                            <label className="form-check-label">
                                                <input type="checkbox" 
                                                className="form-check-input"
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-3"></div> 
                                    ...
                                    <div className="col-md-3">
                                    <Form.Group className="row">
                                        <label className="col-sm-10 col-form-label">Mobile Access:</label>
                                        <div className="col-sm-2 form-check">
                                            <label className="form-check-label">
                                                <input type="checkbox" 
                                                className="form-check-input"
